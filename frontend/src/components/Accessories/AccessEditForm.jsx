        ...
        <div className="w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-3 space-y-4 sm:p-8">
            ...
            <form className="space-y-4" 
              ...
              <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Available: </label>
                <div className="flex items-center space-x-2 mt-2">
                  <button
                    onClick={handleDecrement}
                    className="bg-gray-200 p-2 rounded-l-lg border border-gray-300 hover:bg-gray-300"
                  >
                    -
                  </button>
                  <input
                    ...
                    value={quantity}
                    readOnly
                    className="text-white w-12 text-center border border-gray-300"
                  />
                  <button
                    onClick={handleIncrement}
                    className="bg-gray-200 p-2 rounded-r-lg border border-gray-300 hover:bg-gray-300"
                  >
                    +
                  </button>
                </div>  
